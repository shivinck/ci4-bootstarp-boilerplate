...
describe('Tab', () => {
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav"><li><a href="#home" role="tab">Pages</a></li></ul>',
        '<ul><li id="home"></li></ul>'
      ].join('')
  ...
  describe('show', () => {
    it('should activate element by tab id (using buttons, the preferred semantic way)', done => {
      fixtureEl.innerHTML = [
        ...
        '  <li><button type="button" data-bs-target="#home" role="tab">Pages</button></li>',
    ...
    it('should activate element by tab id (using links for tabs - not ideal, but still supported)', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav" role="tablist">',
        '  <li><a href="#home" role="tab">Pages</a></li>',
    ...
    it('should activate element by tab id in nav list', done => {
      fixtureEl.innerHTML = [
        '<nav class="nav">',
        '  <button type="button" data-bs-target="#home" role="tab">Pages</button>',
    ...
    it('should not fire shown when tab is already active', done => {
      fixtureEl.innerHTML = [
        ...
        '  <li class="nav-item" role="presentation"><button type="button" data-bs-target="#home" class="nav-link active" role="tab" aria-selected="true">Pages</button></li>',
  ...
  describe('data-api', () => {
    ...
    it('selected tab should deactivate previous selected link in dropdown', () => {
      fixtureEl.innerHTML = [
        ...
        '  <li class="nav-item"><a class="nav-link" href="#home" data-bs-toggle="tab">Pages</a></li>',
    ...
    it('selecting a dropdown tab does not activate another', () => {
      const nav1 = [
        ...
        '  <li class="nav-item active"><a class="nav-link" href="#home" data-bs-toggle="tab">Pages</a></li>',
        '  <li class="nav-item dropdown">',
    ...
    it('should support li > .dropdown-item', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs">',
        '  <li class="nav-item"><a class="nav-link active" href="#home" data-bs-toggle="tab">Pages</a></li>',
        '  <li class="nav-item"><a class="nav-link" href="#profile" data-bs-toggle="tab">Profile</a></li>',
        '  <li class="nav-item dropdown">',
        '    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">Dropdown</a>',
    ...
    it('should not remove fade class if no active pane is present', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" role="tablist">',
        '  <li class="nav-item" role="presentation"><button type="button" id="tab-home" data-bs-target="#home" class="nav-link" data-bs-toggle="tab" role="tab">Pages</button></li>',
    ...
    it('should not add show class to tab panes if there is no `.fade` class', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" role="tablist">',
        '  <li class="nav-item" role="presentation">',
        '    <button type="button" class="nav-link nav-tab" data-bs-target="#home" role="tab" data-bs-toggle="tab">Pages</button>',
        '  </li>',
        '  <li class="nav-item" role="presentation">',
    ...
    it('should prevent default when the trigger is <a> or <area>', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav" role="tablist">',
        '  <li><a type="button" href="#test"  class="active" role="tab" data-bs-toggle="tab">Pages</a></li>',
        '  <li><a type="button" href="#test2" role="tab" data-bs-toggle="tab">Pages</a></li>',
        '</ul>'
      ].join('')
    ...
    it('should not fire shown when tab has disabled class', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" role="tablist">',
        '  <li class="nav-item" role="presentation"><a href="#home" class="nav-link active" role="tab" aria-selected="true">Pages</a></li>',
